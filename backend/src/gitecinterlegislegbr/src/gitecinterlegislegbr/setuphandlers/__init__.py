from gitecinterlegislegbr import logger
from gitecinterlegislegbr.setuphandlers import content
from gitecinterlegislegbr.setuphandlers import users
...
class HiddenProfiles(object):
    def getNonInstallableProfiles(self):
        ...
        return [
            "gitecinterlegislegbr:uninstall",
        ]
